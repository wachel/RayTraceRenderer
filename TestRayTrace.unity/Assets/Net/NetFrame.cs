...
namespace NetFrame
{
    ...
    public class TcpClientState
    {
        ...
        public TcpClientState(TcpClient tcpClient, byte[] buffer, long sid)
        {
            if (tcpClient == null)
    ...
    public class AsyncTcpServer : IDisposable
    {
        ...
        //private Dictionary<long,TcpClientState> clients;
        ...
        public AsyncTcpServer(IPAddress localIPAddress, int listenPort)
        {
            ...
            //clients = new Dictionary<long, TcpClientState>();
        ...
        public Action<TcpClientState, byte[]> OnDatagramReceived;
        public Action<TcpClientState> OnClientConnected;
        public Action<TcpClientState> OnClientDisconnected;
